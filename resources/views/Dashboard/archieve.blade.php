...
@section('content')
        <div class="content">
          ...
          <div class="card" id="card-subjectgrade">
              ...
              <div class="title">
                ...
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/viewstudentgrades">Student Grades</a> </li>
            ...
            <a href="#" class="delete-modal btn btn-success mb-2" data-target="#myModal" data-toggle="modal" data-url=""> <i class="fa fa-paper-plane-o"></i> Restore</a>
              ...
              <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content" >
                  ...
                  <div class="modal-footer">
                      ...
                      <button class="btn btn-success deleteBtn" type="button" data-toggle="confirmation"  data-dismiss="modal">Yes</button>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      $(document).on('click', '.delete-modal', function() {
        ...
        $('.modal-title').text('Restore Grades');
        $('.deleteBtn').show();
        $('.actionBtn').hide();
        $('#id').val($(this).data('id'));
        id = $('#id').val();
      ...
      $('.modal-footer').on('click', '.deleteBtn', function() {
        ...
        {  
          if(confirm("Are you sure, you want to move this to restore?"))
          {  
